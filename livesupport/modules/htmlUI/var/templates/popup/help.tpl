...
<div class=blockquote>
  ...
  Playlists appear
    in the ScratchPad differently than sound files. A playlist that is currently open by you
    will appear in <b>bold</b>. You can 'close' a playlist
    directly from the ScratchPad (see the Playlist section for more on opened/closed
    playlists).
    A playlist that is openede by somebody else in marked as locked by small icon, 
...
<div class=blockquote>
  ...
  You can add a
    file (either a sound file or a playlist file) from the ScratchPad to an playlist 
    you opened before by right-clicking it in the ScratchPad and selecting &quot;Add to
    playlist&quot;. This will add it to the end of the playlist.
  &nbsp;
  ...
  You can change
    ...
    right.<br>
    Since LiveSupport 1.0.1 the more advanced drag&drop mode can be opened by 
    clicking on &quot;;Re-arrange playlist&quot;; in Playlist editor.
  &nbsp;
  ...
  Transitions between
    ...
    &quot;Change Transition.&quot; for single interspace, or by using the checkboxes
    in combination with the &quot;Change fades&quote; button.
    In this popup, you can set the length of the transition or fade in/out.
  &nbsp;

    <h3>Openeing and closing a playlist</h3>

  Playlists can
    have status 'opened'. While this, only you can edit the playlist, it is prevented from 
    other people changes and from scheduling. An closed playlist is one that isn´t currently 
    edited by someone, so it can be used  for broadcast, and can be added to the scheduler. 
    An 'opened' playlist can
    continue to be edited. Playlists can be opened for editing by right-clicking
    &quot;Edit&quot; in the ScratchPad menu. This will take you to the playlist
    editor. Just after a playlist have closed (and is on Scratchpad), it will appear in 
    a list of playlists available for scheduling.
</div>

<h2>Schedule</h2>
  <p  >Once you've created a playlist, schedule it for playback using the
    Schedule window. (Please remember that only closed playlists can be added
    to the schedule.)</p>
...
<div class=blockquote>
  ...
  The first step is to select the sound file you want to upload into
    ...
    analyses the sound file for any information that may be stored in ID3 tags.<br>
    See section &quot;Troubleshooting&quot; af you cannot upload files.
...
<div class=blockquote>
  <h3>File Upload</h3>
    If you encounter the message &quot;Uploaded file is bigger than system setting&quot; 
    most probably the file size is bigger than allowed in the PHP system settings of the machine 
    you are running LiveSupport on. Please increase the settings of &quot;upload_max_filesize&quot; 
    and &quot;post_max_size&quot; in php.ini.
    For more information, consult the <a href="http://code.campware.org/manuals/livesupport/1.0/index.php?id=42" target="_blank">LiveSupport manual</a>
    chapter 4.12.
</div>
